...
#define DEFAULT_INPUT_FILENAME "file3.cwl"
...
int main(int argc, char* argv[]) {
	...
	makePrepare(&lastLexemInfoInTable, &lastLexemInfoInTableTemp);
	printLexemes(lexemesInfoTableTemp);
	lastLexemInfoInTableTemp = lexemesInfoTableTemp;
	makeCode(&lastLexemInfoInTableTemp, outCode);
	//printf("\r\n;CODE:\r\n");
...
#if 0
int main123() {
	struct LexemInfo* lastLexemInfoInTable123 = lexemesInfoPreDefinedTable123,
		* lastTempLexemInfoInTable123 = tempLexemesInfoPreDefinedTable123;

	struct LexemInfo* lastLexemInfoInTable12345 = lexemesInfoPreDefinedTable12345;

	printLexemes(lexemesInfoPreDefinedTable123);
	//if (shunting_yard(lexemesInfoPreDefinedTable123, tempLexemesInfoPreDefinedTable123)) {
		//printf("output: %s\n", output);
//        printLexemes(tempLexemesInfoPreDefinedTable123);
//        if (!execution_order_123(tempLexemesInfoPreDefinedTable123)) //bool execution_order(struct LexemInfo* lexemInfoInTable/*, const char* input*/)
//            printf("\nInvalid input\n");
	//}
	//return 0;

	makePrepare(&lastLexemInfoInTable123, &lastTempLexemInfoInTable123);
	printLexemes(tempLexemesInfoPreDefinedTable123);

	printLexemes(lexemesInfoPreDefinedTable12345);
	lastTempLexemInfoInTable123 = tempLexemesInfoPreDefinedTable123;
	makePrepare(&lastLexemInfoInTable12345, &lastTempLexemInfoInTable123);
	printLexemes(tempLexemesInfoPreDefinedTable123);

	//return 0;
	struct LexemInfo* lastTempLexemInfoInTable123_ = tempLexemesInfoPreDefinedTable123;
	makeCode(&lastTempLexemInfoInTable123_, outCode);
